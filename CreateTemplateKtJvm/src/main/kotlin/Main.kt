...
fun main(args: Array<String>) {
    ...
    val fileMapping = CreateTemplateUtil.concatSrcDist(srcMap, distMap)
    ...
    CreateTemplateUtil.copyByFileMapping(fileMapping) { src, dist ->
        println("[Info] ${src.padEnd(maxLength)} -> $dist")
    }
